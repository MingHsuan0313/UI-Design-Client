...
export class ElseBranchStrategy implements ICreateBPELComponentStrategy {
    strategyName: string = "<else> strategy";
    basex: number;
    basey: number;
    ...
    createElseBranchVertex(graphStorage: GraphStorage, component: BPELComponent, parent: any) {
        // image style
        ...
        style[mxConstants.STYLE_IMAGE] = 'src/app/bpel-designer/resources/svg/node.else_branch.svg';
    ...
    createComponent(graphStorage: GraphStorage, component: BPELComponent, parent: any) {
        let elseVertexStorage = this.createElseBranchVertex(graphStorage, component, parent);

        component["x"] = elseVertexStorage.getVertexX();
        component["y"] = elseVertexStorage.getVertexY();
        component["width"] = elseVertexStorage.getVertexWidth();
        component["height"] = elseVertexStorage.getVertexHeight();
