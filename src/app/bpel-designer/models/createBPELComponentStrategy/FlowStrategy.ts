...
export class FlowStrategy implements ICreateBPELComponentStrategy {
    strategyName: string = "<flow> strategy";
    basex: number;
    basey: number;
    ...
    createFlowVertex(graphStorage: GraphStorage, component: BPELComponent, parent: any) {
        // image style
        ...
        style[mxConstants.STYLE_IMAGE] = 'src/app/bpel-designer/resources/svg/node.flow.svg';
    ...
    createComponent(graphStorage: GraphStorage, component: BPELComponent, parent: any) {
        let flowVertexStorage = this.createFlowVertex(graphStorage, component, parent);

        component["x"] = flowVertexStorage.getVertexX();
        component["y"] = flowVertexStorage.getVertexY();
        component["width"] = flowVertexStorage.getVertexWidth();
        component["height"] = flowVertexStorage.getVertexHeight();
