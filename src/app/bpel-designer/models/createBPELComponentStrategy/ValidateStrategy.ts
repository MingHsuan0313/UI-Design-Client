...
export class ValidateStrategy implements ICreateBPELComponentStrategy {
    strategyName: string = "<validate> strategy";
    basex: number;
    basey: number;
    ...
    createValidateVertex(graphStorage: GraphStorage, component: BPELComponent, parent: any) {
        // image style
        ...
        style[mxConstants.STYLE_IMAGE] = 'src/app/bpel-designer/resources/svg/node.action.validate.svg';
    ...
    createComponent(graphStorage: GraphStorage, component: BPELComponent, parent: any) {
        let validateVertexStorage = this.createValidateVertex(graphStorage, component, parent);

        component["x"] = validateVertexStorage.getVertexX();
        component["y"] = validateVertexStorage.getVertexY();
        component["width"] = validateVertexStorage.getVertexWidth();
        component["height"] = validateVertexStorage.getVertexHeight();
